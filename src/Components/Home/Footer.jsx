  ...
  return (
    <div>
      <footer class="text-gray-600 body-font">
        <div class="container px-20 pt-20 pb-10 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col ">
          <div class="w-[30%] flex-shrink-0 md:mx-0 mx-auto text-center md:text-left ">
            <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
              ...
              <span class="ml-3 text-2xl text-warning font-semibold">BuzingBee</span>
            </a>
            <p class="mt-2 text-sm text-gray-500">
              ...
              services, you can acquire web designing, app development, Social
              media management, Search engine optimization, Graphic designing,
              and many more. .
            </p>
            <div className="mt-10">
