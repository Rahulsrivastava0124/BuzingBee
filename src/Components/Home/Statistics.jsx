            ...
            <div class="flex flex-wrap -m-4 text-center">
              ...
              >
                <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  ...
                  <p class="leading-relaxed">Workflows Automated</p>
                </div>
              </div>
              <div
                class="p-4  w-1/2 sm:w-1/4"
              ...
              >
                ...
                >
                  ...
                  <p class="leading-relaxed">Conversion Increase</p>
                </div>
              </div>
              <div
                class="p-4 w-1/2 sm:w-1/4"
              ...
              >
                <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  ...
                  <p class="leading-relaxed">Expert Team</p>
                </div>
              </div>
            </div>
          </div>
