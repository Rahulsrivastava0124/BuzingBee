...
export default function Contact() {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "db9c80b0-b924-416d-b9a5-77585940d244");
        ...
        <div className="md:grid md:min-h-96 md:grid-cols-12">
          ...
          <main className="flex items-center justify-center px-8 py-8 sm:px-12 md:col-span-7 md:px-16 md:py-12 xl:col-span-6">
            <div className="max-w-xl lg:max-w-3xl">
              ...
              <form onSubmit={onSubmit} className="grid grid-cols-6 gap-6 mt-8">
                <input
                  type="hidden"
                  name="subject"
                  value="New Submission from Buzzingbee"
                />
                <input
                  type="hidden"
                  name="from_name"
                  value="BuzingBee Contact"
                />
                ...
                <div className="hidden col-span-6 sm:block">
                ...
                <div className="col-span-6 m-auto sm:flex sm:items-center sm:gap-4">
                  <button
                    type="submit"
                    className="inline-block px-12 py-3 text-sm font-medium text-white transition bg-yellow-600 border border-yellow-400 rounded-md shrink-0 hover:bg-transparent hover:text-yellow-600 focus:outline-none focus:ring active:text-yellow-500 btn-wide"
                  >
                    {result ? (
  ...
  return (
    <>
      {isContactPage ? (
        <div className="w-11/12 max-w-6xl p-2 sm:p-5 mx-auto">
          {contactContent}
        </div>
      ) : (
