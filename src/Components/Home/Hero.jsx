  ...
  return (
    <>
      <div className=" mx-16 my-10 rounded-md flex" >
        <div className="w-[50%] ">
          <h1 className="text-7xl font-medium " data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="1000">
            <span data-aos="fade-up" data-aos-duration="1000">Stay ahead of the </span><span>curve with our</span><span> forword-thinking</span>{" "}
          </h1>
          <h5 className="mt-8 text-lg text-gray-500 pe-32" data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="1100">
            {" "}
          ...
          <div className="mt-16 flex items-center " data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="1200">
