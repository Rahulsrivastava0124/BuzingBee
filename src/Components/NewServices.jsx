...
const NewServices = () => {
  return (
    ...
    <div className="md:w-[90%] w-[100%] my-14 sm:mx-16">
      <div className="container px-5 mx-auto">
        ...
        <div className="flex flex-wrap justify-around mt-10">
          {/* card -1  */}
          <div className="max-w-sm mb-5 overflow-hidden border shadow-lg rounded-xl sm:mb-0 bg-yellow-50" >
            <img
            ...
            <div className="px-6 py-4">
              <div className="mb-2 text-xl font-bold">Web development <span className="text-gray-400">&</span> SEO</div>
          ...
          <div className="max-w-sm mb-5 overflow-hidden border shadow-lg rounded-xl sm:mb-0 bg-yellow-50" >
            ...
            <div className="px-6 py-4">
              <div className="mb-2 text-xl font-bold">Youtube <span className="text-gray-400">&</span>  Social media management</div>
              <p className="hidden text-base text-gray-700 md:block">
